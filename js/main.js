;(function () {
	...
	var windowScroll = function() {
		...
		$(window).scroll(function(event){
			...
			if ( scrlTop > 500 && scrlTop <= 2000 ) {
				header.addClass('navbar-fixed-top main-animated slideInDown');
			} else if ( scrlTop <= 500) {
				if ( header.hasClass('navbar-fixed-top') ) {
					header.addClass('navbar-fixed-top main-animated slideOutUp');
					setTimeout(function(){
						header.removeClass('navbar-fixed-top main-animated slideInDown slideOutUp');
					}, 100 );
				}
			} 
	...
	var servicesAnimate = function() {
		...
		if ( $('#main-our-services').length > 0 ) {	
			$('#main-our-services .to-animate').each(function( k ) {
	...
	var servicesWayPoint = function() {
		...
		if ( $('#main-our-services').length > 0 ) {
			$('#main-our-services').waypoint( function( direction ) {
	...
	var featuresAnimate = function() {
		...
		if ( $('#main-features').length > 0 ) {	
			$('#main-features .to-animate').each(function( k ) {
	...
	var featuresWayPoint = function() {
		...
		if ( $('#main-features').length > 0 ) {
			$('#main-features').waypoint( function( direction ) {
	...
	var testimonialsAnimate = function() {
		...
		if ( $('#main-testimonials').length > 0 ) {	
			$('#main-testimonials .to-animate').each(function( k ) {
	...
	var testimonialsWayPoint = function() {
		...
		if ( $('#main-testimonials').length > 0 ) {
			$('#main-testimonials').waypoint( function( direction ) {
	...
	var pricingAnimate = function() {
		...
		if ( $('#main-pricing').length > 0 ) {	
			$('#main-pricing .to-animate').each(function( k ) {
	...
	var pricingWayPoint = function() {
		...
		if ( $('#main-pricing').length > 0 ) {
			$('#main-pricing').waypoint( function( direction ) {
	...
	var pressAnimate = function() {
		...
		if ( $('#main-press').length > 0 ) {	
			$('#main-press .to-animate').each(function( k ) {
	...
	var pressWayPoint = function() {
		...
		if ( $('#main-press').length > 0 ) {
			$('#main-press').waypoint( function( direction ) {
